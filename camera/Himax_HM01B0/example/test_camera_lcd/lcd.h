...
#define ILI9341_GREEN       0xE007      /*   0, 255,   0 */
...
#define ILI9341_GREEN_LE    0xE007      /*   0, 255,   0 */
...
void lcd_set_pushColor(rt_spim_t *lcd_spim);
void lcd_drawPixel(rt_spim_t *lcd_spim, unsigned short x, unsigned short y, unsigned short color) ;


// NOT IMPLEMENTED!
void lcd_drawFastVLine(rt_spim_t *lcd_spim, unsigned short x, unsigned short y, unsigned short h, unsigned short color) ;
void lcd_drawFastHLine(rt_spim_t *lcd_spim, unsigned short x, unsigned short y, unsigned short w, unsigned short color) ;
void lcd_fillScreen_quick(rt_spim_t *lcd_spim, unsigned short * color) ;
