...
TOOLCHAIN_NAME                := GCC
JTAG                          := CYW9WCD1EVAL1
WICED_SDK_LDFLAGS             += -Wl,--gc-sections -Wl,-Os -Wl,--cref -mthumb -mcpu=cortex-m4 -Wl,-A,thumb -Wl,-z,max-page-size=0x10 -Wl,-z,common-page-size=0x10 -mlittle-endian -nostartfiles -Wl,--defsym,__STACKSIZE__=800 -L ./WICED/platform/MCU/STM32F4xx/GCC -L ./WICED/platform/MCU/STM32F4xx/GCC/STM32F411
RESOURCE_CFLAGS               += -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
RESOURCE_CXXFLAGS             += -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
...
WICED_SDK_PREBUILT_LIBRARIES  += ./WICED/RTOS/ThreadX/ThreadX.ARM_CM4.release.a ./WICED/network/NetX_Duo/NetX_Duo.ThreadX.ARM_CM4.release.a ././libraries/drivers/bluetooth/low_energy/../bluetooth_low_energy.ThreadX.NetX_Duo.ARM_CM4.release.a ././WICED/security/BESL/BESL_generic.ARM_CM4.release.a ././WICED/security/PostgreSQL/PostgreSQL.ARM_CM4.release.a
...
App_WiFi_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Platform_LSRSTERLING_00950_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
ThreadX_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
NetX_Duo_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
WICED_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_SPI_Slave_Library_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_Bluetooth_Embedded_Low_Energy_Stack_for_WICED_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
...
WWD_ThreadX_Interface_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
...
Supplicant_BESL_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -fno-strict-aliasing
Fortuna_PostgreSQL_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -fno-strict-aliasing
...
Lib_WICED_Bluetooth_Firmware_Driver_for_BCM43438A1_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_tracex_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_DHCP_Server_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_Linked_List_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_TLV_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_base64_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
mbedTLS_Open_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   -fno-strict-aliasing
common_GCC_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
STM32F4xx_Peripheral_Drivers_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_Ring_Buffer_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
Lib_crc_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
STM32F4xx_Peripheral_Libraries_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4    -mlittle-endian                   
App_WiFi_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Platform_LSRSTERLING_00950_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
ThreadX_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
NetX_Duo_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WICED_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_SPI_Slave_Library_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_Bluetooth_Embedded_Low_Energy_Stack_for_WICED_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_SPI_Flash_Library_LSRSTERLING_00950_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_GPIO_button_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WWD_ThreadX_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WICED_ThreadX_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WWD_NetX_Duo_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WICED_NetX_Duo_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
WWD_for_SDIO_ThreadX_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Supplicant_BESL_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Fortuna_PostgreSQL_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_DNS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_Wiced_RO_FS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
STM32F4xx_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_WICED_Bluetooth_Firmware_Driver_for_BCM43438A1_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_tracex_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_DHCP_Server_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_Linked_List_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_TLV_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_base64_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
mbedTLS_Open_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
common_GCC_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
STM32F4xx_Peripheral_Drivers_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_Ring_Buffer_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
Lib_crc_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
STM32F4xx_Peripheral_Libraries_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"             -mthumb -mcpu=cortex-m4  -mlittle-endian                   
...
Lib_SPI_Slave_Library_BUILD_TYPE       := release
Lib_Bluetooth_Embedded_Low_Energy_Stack_for_WICED_BUILD_TYPE       := release
...
Lib_WICED_Bluetooth_Firmware_Driver_for_BCM43438A1_BUILD_TYPE       := release
...
OTA_APP := 
DCT_IMAGE := 
FILESYSTEM_IMAGE := build/UniBo.AppWiFi-LSRSTERLING_00950-ThreadX-NetX_Duo-SDIO/filesystem.bin 
WIFI_FIRMWARE :=  
APP0 :=  
APP1 :=  
APP2 :=  
