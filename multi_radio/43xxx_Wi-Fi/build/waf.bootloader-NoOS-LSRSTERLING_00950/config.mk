WICED_SDK_MAKEFILES           += ./WICED/platform/MCU/STM32F4xx/peripherals/libraries/libraries.mk ./libraries/utilities/ring_buffer/ring_buffer.mk ./WICED/platform/MCU/STM32F4xx/peripherals/peripherals.mk ./WICED/platform/GCC/GCC.mk ././WICED/platform/MCU/STM32F4xx/STM32F4xx.mk ./libraries/inputs/gpio_button/gpio_button.mk ./libraries/drivers/spi_flash/spi_flash.mk ././WICED/RTOS/NoOS/WWD/WWD.mk ./libraries/utilities/crc/crc.mk ./libraries/filesystems/wicedfs/wicedfs.mk ././WICED/WICED.mk ./platforms/LSRSTERLING_00950/LSRSTERLING_00950.mk ./WICED/RTOS/NoOS/NoOS.mk ./apps/waf/bootloader/bootloader.mk
TOOLCHAIN_NAME                := GCC
JTAG                          := CYW9WCD1EVAL1
WICED_SDK_LDFLAGS             += -Wl,--gc-sections -Wl,-Os -Wl,--cref -mthumb -mcpu=cortex-m4 -Wl,-A,thumb -Wl,-z,max-page-size=0x10 -Wl,-z,common-page-size=0x10 -mlittle-endian -nostartfiles -Wl,--defsym,__STACKSIZE__=8000 -L ./WICED/platform/MCU/STM32F4xx/GCC -L ./WICED/platform/MCU/STM32F4xx/GCC/STM32F411
RESOURCE_CFLAGS               += -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
RESOURCE_CXXFLAGS             += -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
...
WICED_SDK_INCLUDES            +=                                        -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/. -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/inc -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/../../../ARM_CM4/CMSIS -I./libraries/utilities/ring_buffer/. -I./WICED/platform/MCU/STM32F4xx/peripherals/. -I./WICED/platform/GCC/. -I././WICED/platform/MCU/STM32F4xx/. -I././WICED/platform/MCU/STM32F4xx/.. -I././WICED/platform/MCU/STM32F4xx/../.. -I././WICED/platform/MCU/STM32F4xx/../../include -I././WICED/platform/MCU/STM32F4xx/../../ARM_CM4 -I././WICED/platform/MCU/STM32F4xx/../../ARM_CM4/CMSIS -I././WICED/platform/MCU/STM32F4xx/peripherals -I././WICED/platform/MCU/STM32F4xx/WAF -I./libraries/inputs/gpio_button/. -I./libraries/drivers/spi_flash/. -I././WICED/RTOS/NoOS/WWD/. -I././WICED/RTOS/NoOS/WWD/Cortex_M3_M4 -I./libraries/utilities/crc/. -I./libraries/filesystems/wicedfs/src -I././WICED/WWD/include -I././WICED/security/BESL/include -I././WICED/security/BESL/host/WICED -I././WICED/security/BESL/crypto_internal -I././WICED/security/PostgreSQL/include -I././WICED/security/BESL/mbedtls_open/include -I././WICED/. -I././WICED/platform/include -I././WICED/../apps/UniBo/AppWiFi -I./platforms/LSRSTERLING_00950/. -I./platforms/LSRSTERLING_00950/./libraries/inputs/gpio_button -I./WICED/RTOS/NoOS/. -I./apps/waf/bootloader/. -I./apps/waf/bootloader/../../../libraries/utilities/linked_list -I./WICED/WWD/internal/chips/4343x -I./libraries -I./include
WICED_SDK_DEFINES             +=                                       -DSFLASH_APPS_HEADER_LOC=0x0000 -DUSE_STDPERIPH_DRIVER -D_STM3x_ -D_STM32x_ -DSTM32F411xE -DPLATFORM_SUPPORTS_LOW_POWER_MODES -DMAX_WATCHDOG_TIMEOUT_SECONDS=22 -DUSING_WICEDFS -DNO_WICED_API -DWWD_STARTUP_DELAY=10 -DBOOTLOADER_MAGIC_NUMBER=0x4d435242 -DHSE_VALUE=8000000 -DCRLF_STDIO_REPLACEMENT -DWICED_DCT_INCLUDE_BT_CONFIG -DRTOS_NoOS=1 -DWICED_NO_WIFI -DWICED_DISABLE_STDIO -DWICED_DISABLE_MCU_POWERSAVE -DWICED_DCACHE_WTHROUGH -DNO_WIFI_FIRMWARE -DBOOTLOADER -DDCT_CRC32_CALCULATION_SIZE_ON_STACK=1024 -DWICED_SDK_WIFI_CONFIG_DCT_H=\"./include/default_wifi_config_dct.h\" -DWICED_SDK_BT_CONFIG_DCT_H=\"./include/default_bt_config_dct.h\"
COMPONENTS                := App_WICED_Bootloader_LSRSTERLING_00950 NoOS Platform_LSRSTERLING_00950 WICED Lib_Wiced_RO_FS Lib_crc WWD_NoOS_Interface Lib_SPI_Flash_Library_LSRSTERLING_00950 Lib_GPIO_button STM32F4xx common_GCC STM32F4xx_Peripheral_Drivers Lib_Ring_Buffer STM32F4xx_Peripheral_Libraries
BUS                       := SDIO
IMAGE_TYPE                := ram
NETWORK_FULL              := 
RTOS_FULL                 := NoOS
...
App_WICED_Bootloader_LSRSTERLING_00950_LOCATION         := ./apps/waf/bootloader/
...
App_WICED_Bootloader_LSRSTERLING_00950_SOURCES          += bootloader.c
NoOS_SOURCES          += 
...
App_WICED_Bootloader_LSRSTERLING_00950_CHECK_HEADERS    += 
NoOS_CHECK_HEADERS    += 
...
App_WICED_Bootloader_LSRSTERLING_00950_INCLUDES         := 
NoOS_INCLUDES         := 
...
App_WICED_Bootloader_LSRSTERLING_00950_DEFINES          := 
NoOS_DEFINES          := 
...
App_WICED_Bootloader_LSRSTERLING_00950_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
NoOS_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
Platform_LSRSTERLING_00950_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
WICED_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_Wiced_RO_FS_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_crc_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
WWD_NoOS_Interface_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_SPI_Flash_Library_LSRSTERLING_00950_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_GPIO_button_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
STM32F4xx_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
common_GCC_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
STM32F4xx_Peripheral_Drivers_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
Lib_Ring_Buffer_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
STM32F4xx_Peripheral_Libraries_CFLAGS           := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
App_WICED_Bootloader_LSRSTERLING_00950_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
NoOS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Platform_LSRSTERLING_00950_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
WICED_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_Wiced_RO_FS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_crc_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
WWD_NoOS_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_SPI_Flash_Library_LSRSTERLING_00950_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_GPIO_button_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
common_GCC_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_Peripheral_Drivers_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_Ring_Buffer_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_Peripheral_Libraries_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.000.001.0005\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-LSRSTERLING_00950/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
App_WICED_Bootloader_LSRSTERLING_00950_ASMFLAGS         :=     -mcpu=cortex-m4 -mfpu=softvfp  -mlittle-endian          
...
App_WICED_Bootloader_LSRSTERLING_00950_RESOURCES        := 
NoOS_RESOURCES        := 
...
App_WICED_Bootloader_LSRSTERLING_00950_MAKEFILE         := ./apps/waf/bootloader/bootloader.mk
...
App_WICED_Bootloader_LSRSTERLING_00950_PRE_BUILD_TARGETS:= 
...
App_WICED_Bootloader_LSRSTERLING_00950_PREBUILT_LIBRARY := 
...
App_WICED_Bootloader_LSRSTERLING_00950_BUILD_TYPE       := release
...
OTA_APP := 
DCT_IMAGE := 
FILESYSTEM_IMAGE := build/waf.bootloader-NoOS-LSRSTERLING_00950/filesystem.bin 
WIFI_FIRMWARE :=  
APP0 :=  
APP1 :=  
APP2 :=  
